...
export const GenerationInput = () => {
  ...
  return (
    <div style={creatorMode ? {}: {pointerEvents: 'none', opacity: 0}} className='fixed p-[0px_8.53vw_7.22vw] w-full bottom-0 left-0 right-0 transition-all'>
      <input 
        value={inputValue} 
        onChange={handleChange} 
        className={`fs-15 font-normal urbanist border transition-all ${isFocus ? 'border-primary': 'border-[#E1E1E1]'} w-full rounded-[7px] p-[2.68vw_14.45vw_2.68vw_3.34vw]`}
