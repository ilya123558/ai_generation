...
export const GenerationInput = ({prompt, setPrompt, handleGenerateImage, isFocusInput, setIsFocusInput}: IProps) => {
  ...
  return (
    <form
      ...
      style={creatorMode ? {} : { pointerEvents: 'none', opacity: 0 }}
      className="p-[0px_8.53vw_0vw] w-full transition-all relative"
    >
      <div className="relative w-full">
        <input
          value={prompt}
          onChange={handleChange}
          className={`text-[16px] font-normal urbanist border transition-all w-full rounded-[7px] p-[2.68vw_14.45vw_2.68vw_3.34vw] ${
            isFocusInput ? 'border-primary' : 'border-[#E1E1E1]'
          }`}
        ...
        <button
          ...
          className="absolute top-[2vw] right-[3vw] w-[8.28vw] h-[7.98vw] flex items-center justify-center"
        >
          <svg
