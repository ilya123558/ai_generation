...
export const CreatorMode = () => {
  ...
  return (
    <>
      {isOpenCreatorModeInfo && (
        <CreatorModeInfoModal 
          isOpen={isOpenCreatorModeInfo} 
          setIsOpen={setIsOpenCreatorModeInfo}
        />
      )}
      {isOpenCreatorModeBuy && (
        <CreatorModeBuyModal
         isOpen={isOpenCreatorModeBuy} 
         setIsOpen={setIsOpenCreatorModeBuy}
       />
      )}
